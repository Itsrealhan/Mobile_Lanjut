import 'package:tugas_api/app/models/productnote.dart';
import 'package:vania/vania.dart';

class ProductnoteController extends Controller {
  Future<Response> index() async {
    List<Map<String, dynamic>> productNotes = await Productnote()
        .query()
  ...
  Future<Response> create(Request request) async {
    ...
    final productNotes = await Productnote().query().insert({
